...
from Ex_04_project.food import Vegetable, Fruit, Seed, Meat
from Ex_04_project.food import Food
...
# abstract class inherits other abstract class (Animal, ABC) - this allow us NOT to use all @abstractmethods
