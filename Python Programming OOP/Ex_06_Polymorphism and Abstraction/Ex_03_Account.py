...
# Print an account instance
    def __str__(self):
        return f"Account of {self.owner} with starting amount: {self.amount}"

# Print representational string of an account instance
    def __repr__(self):
...
# Iterate over an account instance
    ...
    def __add__(self, other):
        ...
        starting_amount = self.balance + other.balance
